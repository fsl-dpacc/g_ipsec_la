...
#AVS 09/1 CONFIG_ASF_SEC4x=y
#AVS 09/1 EXTRA_CFLAGS += -DCONFIG_ASF_SEC4x
endif
else
#AVS CONFIG_ASF_SEC4x=y
#AVS EXTRA_CFLAGS += -DCONFIG_ASF_SEC4x
endif
...
EXTRA_CFLAGS += -I$(KERNEL_PATH)/drivers/net/ethernet/intel/e1000
